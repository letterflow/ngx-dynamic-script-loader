...
const noop = (...args: any[]): void => undefined;

/**
 *
 * @publicApi
 */
export interface NgxDynamicScriptRef
  extends NgxDynamicScript,
    Partial<NgxDynamicScriptConfig> {}
...
export class NgxDynamicScriptLoaderConfig {
   ...
   */
  onLoad: (script: NgxDynamicScriptLoaded) => void =
    NGX_DEFAULT_LOAD_SCRIPT_CONFIG.onLoad;
}
